...
/* in modern computers there is no reason to use single-precision anymore */
/* for performance reasons or otherwise, so I'll just remove that option. */
/* -Angela */
#define REAL double
...
#define NO_TIMER /* I'm on Windows -Angela */
...
/* todo: remove references to these defines -Angela */
/* #define REDUCED */
/* #define CDT_ONLY */
